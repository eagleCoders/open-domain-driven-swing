 ...
 *
 */
@Button(buttonType = ActionTypes.SEARCH_ACTION, buttonLabel = "Search" )
public class SearchButtonWidget<T extends IComponent> extends BaseButtonWidget<T> implements IButton {
	...
	static {
		...
		String deleteIconFile = ImageLoaderUtils.loadImage("search-1.png");
		
		icon = new ImageIcon(deleteIconFile);
	}

	public SearchButtonWidget(T component) {
		
		super(component, icon, "Search");
	}
