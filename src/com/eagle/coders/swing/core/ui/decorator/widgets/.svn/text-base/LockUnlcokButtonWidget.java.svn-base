 ...
 *
 */
@Button(buttonType= ActionTypes.LOCK_ACTION)
public class LockUnlcokButtonWidget<T extends IComponent> extends BaseButtonWidget<T> implements IButton {
	...
	public LockUnlcokButtonWidget(T component) {
		
		super(component, icon, "Lock");
	}
